...
batchSize = 32
trainingDataPath = '/data/Training_Data/UTK_Upload/16-20/combined'### Directory for training image for Discriminator
outputPath = '/data/Output_Data/utk_wgan' ### Output dir
inferenceInputPath = None #add inference path
inferenceOutputPath = None #add inference path
modelCheckpointPathG = '/data/Output_Data/model/generatorWgan1620.pt'
modelCheckpointPathD = '/data/Output_Data/model/discriminatorWgan1620.pt'
maxIteration = 500000
discriminatorIter = 1
imageSize = 128
